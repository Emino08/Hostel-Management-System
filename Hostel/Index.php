        ...
        $("#submit").click(() => {
            ...
            $.post("./slogin.php", {
                ...
                function(data, status) {
                    ...
                    if (data == 'uname') {
                        $("#dispay_success").html(
                            "<div class='w3-panel w3-red'>Invalid Username</div>");
                        $("#susername").addClass("w3-border-red")
                    } else if (data == 'pword') {
                        $("#dispay_success").html(
                            "<div class='w3-panel w3-red'>Invalid Password</div>");
                        $("#susername").removeClass("w3-border-red")
                        $("#spassword").addClass("w3-border-red")
                    } else if (data === 'true') {
                        alert("You are log in.....")
                        window.location.href = "./student/book_hostel.php"
                    }
...
margin-bottom: 100px;">
        ...
        <p class="w3-center">Student Login</p>
        <div id="dispay_success"></div>

        <form class="w3-container">
            <p>
                <input class="w3-input w3-border w3-round-xlarge" id="susername" type="text"
                    placeholder="Email or Student ID">
            </p>
            <p>
            <p>
                <input class="w3-input w3-border w3-round-xlarge" id="spassword" type="password" placeholder="Password">
            </p>
            <p>
